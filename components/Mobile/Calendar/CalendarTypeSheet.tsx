...
interface CalendarTypeSheetProps {
  isOpen: boolean
  onClose: () => void
}

export default function CalendarTypeSheet({ isOpen, onClose }: CalendarTypeSheetProps) {
  ...
  const handleDelete = (typeId: string) => {
    if (confirm('Delete this calendar type?')) {
    ...
    <div className="fixed inset-0 z-50 flex items-end bg-black/50">
      <div className="bg-white w-full max-h-[80vh] rounded-t-2xl animate-slide-up">
        ...
        <div className="flex items-center justify-between p-4 border-b">
          <h2 className="text-lg font-semibold text-gray-800">Calendar Types</h2>
          <button
            onClick={onClose}
          ...
          <div className="mb-6">
            ...
            <div className="flex gap-2">
              ...
              <button
                ...
                className="p-2 bg-squarage-green hover:bg-squarage-green/90 disabled:bg-gray-300 text-white rounded-lg transition-colors"
              >
                <Plus size={20} />
              </button>
            </div>
